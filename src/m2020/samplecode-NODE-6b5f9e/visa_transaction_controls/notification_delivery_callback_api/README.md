...
This is a sample implementation of pmc_104 only for reference purpose.
...
```node
'use strict';
var api = require('../src/pmc_104').pmc_104;
var authCredentials = require('../../creds');

var pmc_104 = new api(authCredentials);

pmc_104.(getParameters())
