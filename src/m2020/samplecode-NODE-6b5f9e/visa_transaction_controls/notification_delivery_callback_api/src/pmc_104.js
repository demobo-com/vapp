...
const pmc_104 = (function () {
  ...
  /**
     * Alert Notification
     * @method
     * @name pmc_104#deliveryCb
     * @param {string} xClientTransactionId -
     * @param {} deliveryCbPOSTPayload - Resource body for Alert Notification
     *
     */
  pmc_104.prototype.deliveryCb = function (parameters) {
    ...
    const path = '/ConsumerTransactionControls/v1/notifications';
