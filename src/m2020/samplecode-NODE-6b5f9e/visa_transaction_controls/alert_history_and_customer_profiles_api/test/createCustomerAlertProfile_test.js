...
// path invoked is '/vctc/customerrules/v1/consumertransactioncontrols/customer';
pmc_105.createCustomerAlertProfile(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- createCustomerAlertProfile ---------------');
