...
// path invoked is '/vctc/customerrules/v1/consumertransactioncontrols/customer/{userIdentifier}';
pmc_105.customerAlertsProfile(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- customerAlertsProfile ---------------');
