...
// path invoked is '/vctc/customerrules/v1/consumertransactioncontrols/customer/notificationInquiry';
pmc_105.GetNotificationsSummaryByPanOrToken(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- GetNotificationsSummaryByPanOrToken ---------------');
