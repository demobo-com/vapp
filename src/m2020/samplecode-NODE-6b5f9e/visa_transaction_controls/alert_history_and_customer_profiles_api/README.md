...
This is a sample implementation of pmc_105 only for reference purpose.
...
```node
'use strict';
var api = require('../src/pmc_105').pmc_105;
var authCredentials = require('../../creds');

var pmc_105 = new api(authCredentials);

pmc_105.(getParameters())
