...
This is a sample implementation of pmc_103 only for reference purpose.
...
```node
'use strict';
var api = require('../src/pmc_103').pmc_103;
var authCredentials = require('../../creds');

var pmc_103 = new api(authCredentials);

pmc_103.(getParameters())
