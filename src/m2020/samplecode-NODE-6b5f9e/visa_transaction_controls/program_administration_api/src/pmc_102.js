...
const pmc_102 = (function () {
  ...
  /**
     ...
     * @method
     * @name pmc_102#manageTransactionControls
     * @param {string} xClientTransactionId -
     * @param {} manageTransactionControlsDELETEPayload - Resource body for Delete transaction controls allowed for an issuer
     *
     */
  pmc_102.prototype.manageTransactionControls = function (parameters) {
    ...
    const path = '/vctc/programadmin//v1/configuration/transactiontypecontrols';
  ...
  /**
     ...
     * @method
     * @name pmc_102#manageRuleConfiguration
     * @param {string} xClientTransactionId -
     * @param {} manageRuleConfigurationDELETEPayload - Resource body for Delete rule configuration and capabilities allowed for an issuer
     *
     */
  pmc_102.prototype.manageRuleConfiguration = function (parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    const deferred = Q.defer();
    ...
    const domain = this.domain;
    const path = '/vctc/programadmin//v1/sponsors/configuration';
