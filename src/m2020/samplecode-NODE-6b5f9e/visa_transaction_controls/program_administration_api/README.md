...
This is a sample implementation of pmc_102 only for reference purpose.
...
```node
'use strict';
var api = require('../src/pmc_102').pmc_102;
var authCredentials = require('../../creds');

var pmc_102 = new api(authCredentials);

pmc_102.(getParameters())
