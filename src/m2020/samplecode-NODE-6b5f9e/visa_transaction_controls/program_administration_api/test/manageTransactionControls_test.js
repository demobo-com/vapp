...
// path invoked is '/vctc/programadmin//v1/configuration/transactiontypecontrols';
pmc_102.manageTransactionControls(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- manageTransactionControls ---------------');
