...
This is a sample implementation of pmc_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/pmc_100').pmc_100;
var authCredentials = require('../../creds');

var pmc_100 = new api(authCredentials);

pmc_100.(getParameters())
