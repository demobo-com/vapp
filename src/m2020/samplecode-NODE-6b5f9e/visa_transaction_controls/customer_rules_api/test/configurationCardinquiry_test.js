...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/configuration/cardinquiry';
pmc_100.configurationCardinquiry(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- configurationCardinquiry ---------------');
