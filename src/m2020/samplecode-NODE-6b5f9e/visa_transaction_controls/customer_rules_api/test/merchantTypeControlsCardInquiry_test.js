...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/merchanttypecontrols/cardinquiry';
pmc_100.merchantTypeControlsCardInquiry(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- merchantTypeControlsCardInquiry ---------------');
