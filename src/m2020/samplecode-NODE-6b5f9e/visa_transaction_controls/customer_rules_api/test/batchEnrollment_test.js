...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/batch';
pmc_100.batchEnrollment(getParameters())
  .then((result) => {
...
function getParameters() {
  const parameters = {
    ...
    'App-ID': '{enter appropriate value}',
    'Sponsor-ID': '{enter appropriate value}',
