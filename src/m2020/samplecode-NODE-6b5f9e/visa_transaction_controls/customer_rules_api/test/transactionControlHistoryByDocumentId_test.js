...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/controlHistory';
pmc_100.transactionControlHistoryByDocumentId(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- transactionControlHistoryByDocumentId ---------------');
