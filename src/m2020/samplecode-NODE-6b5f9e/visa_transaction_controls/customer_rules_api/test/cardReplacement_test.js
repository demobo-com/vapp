...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/accounts/accountupdate';
pmc_100.cardReplacement(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- cardReplacement ---------------');
