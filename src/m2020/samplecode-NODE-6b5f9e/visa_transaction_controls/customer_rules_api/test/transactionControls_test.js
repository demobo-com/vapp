...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/transactiontypecontrols/cardinquiry';
pmc_100.transactionControls(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- transactionControls ---------------');
