...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/applications/configuration';
pmc_100.applicationConfiguration(getParameters())
  .then((result) => {
...
function getParameters() {
  ...
  parameters.payload = {
    callBackSettings: {
      ...
      callBackEndpoint: 'https://abc/com/enrollment',
