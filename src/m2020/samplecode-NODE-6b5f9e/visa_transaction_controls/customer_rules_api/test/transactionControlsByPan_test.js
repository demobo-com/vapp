...
// path invoked is '/vctc/customerrules//v1/consumertransactioncontrols/inquiries/cardinquiry';
pmc_100.transactionControlsByPan(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- transactionControlsByPan ---------------');
