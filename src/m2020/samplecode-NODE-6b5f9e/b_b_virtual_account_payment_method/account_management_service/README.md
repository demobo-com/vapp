...
This is a sample implementation of vpa_104 only for reference purpose.
...
```node
'use strict';
var api = require('../src/vpa_104').vpa_104;
var authCredentials = require('../../creds');

var vpa_104 = new api(authCredentials);

vpa_104.(getParameters())
