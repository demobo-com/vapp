...
// path invoked is '/vpa/v1/accountManagement/GetAccountStatus';
vpa_104.getaccountStatus(getParameters())
  .then((result) => {
...
function getParameters() {
  ...
  parameters.payload = {
    buyerId: 9999,
    messageId: '1526314567857',
    supplierId: 'APISupp-0078',
    clientId: 'B2BWS_1_1_9999',
    accountRequestId: 1299760319511,
  };
