...
// path invoked is '/vpa/v1/accountManagement/ListPaymentControl';
vpa_104.listpaymentControl(getParameters())
  .then((result) => {
    // Put your custom logic here
    console.log('--------------- listpaymentControl ---------------');
