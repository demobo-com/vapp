...
This is a sample implementation of vpa_103 only for reference purpose.
...
```node
'use strict';
var api = require('../src/vpa_103').vpa_103;
var authCredentials = require('../../creds');

var vpa_103 = new api(authCredentials);

vpa_103.(getParameters())
