...
This is a sample implementation of vpa_101 only for reference purpose.
...
```node
'use strict';
var api = require('../src/vpa_101').vpa_101;
var authCredentials = require('../../creds');

var vpa_101 = new api(authCredentials);

vpa_101.(getParameters())
