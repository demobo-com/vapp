...
This is a sample implementation of vpa_102 only for reference purpose.
...
```node
'use strict';
var api = require('../src/vpa_102').vpa_102;
var authCredentials = require('../../creds');

var vpa_102 = new api(authCredentials);

vpa_102.(getParameters())
