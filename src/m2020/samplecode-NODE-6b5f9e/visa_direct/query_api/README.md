...
This is a sample implementation of qury_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/qury_100').qury_100;
var authCredentials = require('../../creds');

var qury_100 = new api(authCredentials);

qury_100.(getParameters())
