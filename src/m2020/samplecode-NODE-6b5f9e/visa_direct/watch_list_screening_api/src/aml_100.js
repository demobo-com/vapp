...
const aml_100 = (function () {
  ...
  /**
     ...
     * @method
     * @name aml_100#watchlistinquiry
     * @param {string} xClientTransactionId -
     * @param {} watchlistinquiryPOSTPayload - Resource body for Get Status
     *
     */
  aml_100.prototype.watchlistinquiry = function (parameters) {
    ...
    const path = '/visadirect/watchlistscreening/v1/watchlistinquiry';
