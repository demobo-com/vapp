...
This is a sample implementation of aml_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/aml_100').aml_100;
var authCredentials = require('../../creds');

var aml_100 = new api(authCredentials);

aml_100.(getParameters())
