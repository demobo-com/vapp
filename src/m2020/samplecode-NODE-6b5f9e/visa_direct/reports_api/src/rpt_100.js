...
const rpt_100 = (function () {
  ...
  /**
     * Transaction Data
     * @method
     * @name rpt_100#reportingApi
     * @param {string} xClientTransactionId -
     * @param {} fromDate -
     * @param {} toDate -
     *
     */
  rpt_100.prototype.reportingApi = function (parameters) {
    ...
    const path = '/visadirect/reports/v1/transactiondata';
