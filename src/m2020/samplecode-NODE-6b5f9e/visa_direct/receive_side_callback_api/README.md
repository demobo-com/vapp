...
This is a sample implementation of rcvs_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/rcvs_100').rcvs_100;
var authCredentials = require('../../creds');

var rcvs_100 = new api(authCredentials);

rcvs_100.(getParameters())
