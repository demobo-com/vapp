...
This is a sample implementation of alias_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/alias_100').alias_100;
var authCredentials = require('../../creds');

var alias_100 = new api(authCredentials);

alias_100.(getParameters())
