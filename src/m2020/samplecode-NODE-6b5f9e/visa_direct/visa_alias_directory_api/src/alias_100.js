...
const alias_100 = (function () {
  ...
  /**
     ...
     *
     */
  alias_100.prototype.Resolve = function (parameters) {
    ...
    const path = '/visaaliasdirectory/v1/resolve';
  ...
  alias_100.prototype.CreateAlias = function (parameters) {
    ...
    const domain = this.domain;
    const path = '/visaaliasdirectory/v1/manage/createalias';
  ...
  alias_100.prototype.DeleteAlias = function (parameters) {
    ...
    const domain = this.domain;
    const path = '/visaaliasdirectory/v1/manage/deletealias';
  ...
  alias_100.prototype.UpdateAlias = function (parameters) {
    ...
    const domain = this.domain;
    const path = '/visaaliasdirectory/v1/manage/updatealias';
  ...
  /**
     ...
     * @method
     * @name alias_100#GetAlias
     *
     */
  alias_100.prototype.GetAlias = function (parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    const deferred = Q.defer();
    ...
    const domain = this.domain;
    const path = '/visaaliasdirectory/v1/manage/{guid}';
