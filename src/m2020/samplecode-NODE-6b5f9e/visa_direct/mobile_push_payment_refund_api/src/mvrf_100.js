...
const mvrf_100 = (function () {
  ...
  /**
     ...
     * @method
     * @name mvrf_100#merchandiseReturnReversalPost
     ...
     *
     */
  mvrf_100.prototype.merchandiseReturnReversalPost = function (parameters) {
    ...
    const path = '/visadirect/mvisa/v1/mrr';
  ...
  /**
     ...
     * @method
     * @name mvrf_100#merchandiseReturnPost
     * @param {string} xClientTransactionId -
     * @param {} merchandiseReturnPostPOSTPayload - Resource body for MerchandiseReturn POST
     *
     */
  mvrf_100.prototype.merchandiseReturnPost = function (parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    const deferred = Q.defer();
    ...
    const domain = this.domain;
    const path = '/visadirect/mvisa/v1/mr';
  ...
  /**
     ...
     * @method
     * @name mvrf_100#merchandiseReturnGet
     *
     */
  mvrf_100.prototype.merchandiseReturnGet = function (parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    const deferred = Q.defer();
    ...
    const domain = this.domain;
    const path = '/visadirect/mvisa/v1/mr/{statusIdentifier}';
  ...
  /**
     ...
     * @method
     * @name mvrf_100#merchandiseReturnReversalGet
     *
     */
  mvrf_100.prototype.merchandiseReturnReversalGet = function (parameters) {
    if (parameters === undefined) {
      parameters = {};
    }
    const deferred = Q.defer();
    ...
    const domain = this.domain;
    const path = '/visadirect/mvisa/v1/mrr/{statusIdentifier}';
