...
This is a sample implementation of mvrf_100 only for reference purpose.
...
```node
'use strict';
var api = require('../src/mvrf_100').mvrf_100;
var authCredentials = require('../../creds');

var mvrf_100 = new api(authCredentials);

mvrf_100.(getParameters())
